...
export default {
  ...
  mount(stage, ctx) {
    ...
    ctx.addStyle(`
      ...
      .g-relay .lanes { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; align-items: start; }
      .g-relay .lane { border-radius: 16px; padding: 8px 6px 10px; min-height: 280px; }
      ...
      .g-relay .team-msg { text-align: center; font-weight: bold; font-size: 0.95rem; min-height: 1.4em; margin-top: 2px; }
      .g-relay .team-built { min-height: 44px; background: rgba(255, 255, 255, 0.8); border-radius: 12px; padding: 4px; margin: 6px 2px; text-align: center; }
      .g-relay .team-pool { text-align: center; }
      .g-relay .word-tile { min-height: 52px; padding: 6px 10px; margin: 3px; font-size: 0.95rem; border-radius: 12px; }
      ...
      .g-relay .team-built .word-tile { min-height: 30px; padding: 2px 8px; margin: 2px; font-size: 0.78rem; box-shadow: none; }
      ...
      @media (max-width: 520px) {
        .g-relay .word-tile { font-size: 0.85rem; padding: 5px 8px; }
        .g-relay .team-banner { font-size: 0.95rem; }
      }
    `);
    ...
    function makeLane(team, emoji, name) {
      ...
      const msg = el('div', 'team-msg', 'Ready…');
      const built = el('div', 'team-built');
      const pool = el('div', 'team-pool');
      lane.append(banner, msg, built, pool);
